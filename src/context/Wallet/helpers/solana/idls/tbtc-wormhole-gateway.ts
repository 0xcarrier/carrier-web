  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false,
          isSigner: false,
          docs: ['sign for transferring via Token Bridge program with a message.'],
        },
        {
          name: 'systemProgram',
          isMut: false,
      ...
      accounts: [
        {
          ...
          isMut: true,
          isSigner: false,
          docs: ['NOTE: This account also acts as a minter for the TBTC program.'],
        },
        {
          name: 'wrappedTbtcToken',
          isMut: true,
        ...
        },
        {
          ...
          isMut: true,
          isSigner: false,
          docs: ['This mint is owned by the TBTC program. This PDA address is stored in the custodian account.'],
        },
        {
          name: 'recipientWrappedToken',
          isMut: true,
