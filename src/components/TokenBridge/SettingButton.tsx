...
interface Props {
  ...
  isRelayerSettingDisabled: boolean;
  onSetIsUsingRelayer: (isUsingRelayer: boolean) => void;
}

export const SettingButton: React.SFC<Props> = ({
  className,
  isUsingRelayer,
  ...
  return (
    <SettingButtonModal
      ...
      isRelayerSettingDisabled={isRelayerSettingDisabled}
        ...
        <Modal
          ...
          <div className={OptionsWrapper}>
            <div className={OptionsItemStyle}>
              ...
              <Switch
                disabled={isRelayerSettingDisabled}
